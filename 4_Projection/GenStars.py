...
mrcDir = os.path.join(parDir, '3_Occupancies/MRC_clones') #occupancies from non-uniform occupancy map
...
for i in mrcPaths:
    ...
    ##########################
    # import angles:
    S2 = pd.read_csv('tessellations/proj362.txt', header=None, delim_whitespace=True) #projections
